...
interest['Buisness'] = int(input('Interest in Computer Science? '))
...
taken['Language'] = lang
math = 'Geometry' if input('Geometry? ').__contains__('y' or 'Y') else 'Algebra' if input('Algebra? ').__contains__('y' or 'Y') else ""
taken['Math'] = math
